...
### required
[ -z "$HUB_DOMAIN" ] && export HUB_DOMAIN="example.net"
[ -z "$ADM_EMAIL" ]  && export ADM_EMAIL="admin@example.net"

[ -z "$Namespace" ] && export Namespace="hcce"

[ -z "$DB_USER" ] && export DB_USER="postgres"
[ -z "$DB_PASS" ] && export DB_PASS="123456"
[ -z "$DB_NAME" ] && export DB_NAME="retdb"
[ -z "$DB_HOST" ] && export DB_HOST="pgbouncer"

[ -z "$SMTP_SERVER" ] && export SMTP_SERVER="changeMe"
[ -z "$SMTP_PORT" ]   && export SMTP_PORT="changeMe"
[ -z "$SMTP_USER" ]   && export SMTP_USER="changeMe"
[ -z "$SMTP_PASS" ]   && export SMTP_PASS="changeMe"

[ -z "$NODE_COOKIE" ]  && export NODE_COOKIE="changeMe"
[ -z "$GUARDIAN_KEY" ] && export GUARDIAN_KEY="changeMe"
[ -z "$PHX_KEY" ]      && export PHX_KEY="changeMe"

[ -z "$SKETCHFAB_API_KEY" ] && export SKETCHFAB_API_KEY="changeMe"
[ -z "$TENOR_API_KEY" ]     && export TENOR_API_KEY="changeMe"
